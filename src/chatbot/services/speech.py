...
def speech_to_text(language):
    ...
    if language == "":
        ...
        try:
            ...
            text_to_speech(translate("I'm sorry, I didn't catch that! could you try saying that again?", language), language)
            transcript = None
    return language, transcript

# english_speech = r.recognize_google(audio, language='en')
# english_speech_confidence = r.recognize_google(audio, language='en', show_all=True)['alternative'][0]['confidence']
# chinese_speech = r.recognize_google(audio, language='zh')
# chinese_speech_confidence = r.recognize_google(audio, language='zh', show_all=True)['alternative'][0]['confidence']
    # if english_speech_confidence >= chinese_speech_confidence:
    #     speech_input = "en"
    #     transcript = english_speech
    # else:
    ...
    #
    # if language == "":
    #     return speech_input, transcript
    # else:
    #     return language, transcript
